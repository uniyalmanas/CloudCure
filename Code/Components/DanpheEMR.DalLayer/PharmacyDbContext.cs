...
namespace DanpheEMR.DalLayer
{
    ...
    public class PharmacyDbContext : AuditDbContext
    {
        ...
        public PharmacyDbContext(string conn) : base()
        {
            _connString = conn;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PHRMPrescriptionModel>()
                .HasMany(p => p.PHRMPrescriptionItems)
                .WithOne()
            ...
            modelBuilder.Entity<BillSettlementModel>()
                .HasMany(s => s.BillingTransactions)
                .WithOne()
            ...
            modelBuilder.Entity<PHRMStockMaster>()
                ...
                .WithOne()
                .HasForeignKey<PHRMStockMaster>(a => a.BarcodeId);
