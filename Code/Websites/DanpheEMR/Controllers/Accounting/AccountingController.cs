...
namespace DanpheEMR.Controllers
{
    ...
    public class AccountingController : CommonController
    {
        ...
        //        List<TransactionModel> txnList = accountingDBContext.Transactions.Where(a => ((DateTime)a.TransactionDate).Date == reverseTransactionData.TransactionDate && a.SectionId == reverseTransactionData.Section
        ...
        private object ReverseTransaction(string str, RbacUser currentUser, int currentHospitalId)
        {
            try
            {
                ...
                //get all transaction with matching sectionId and date
                List<TransactionModel> txnList = _accountingDbContext.Transactions.Where(a => ((DateTime)a.TransactionDate).Date == reverseTransactionData.TransactionDate && a.SectionId == reverseTransactionData.Section
                                                                                     && a.IsReverseTxnAllow != false && a.HospitalId == currentHospitalId).Select(a => a).ToList();
