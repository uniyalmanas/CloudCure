    ...
    public class AccountingReportController : CommonController
    {
        ...
        public string LedgerListReport([FromBody] LedgerReportRequest_DTO clientData)
        {
            ...
            if (clientData != null)
            {
                ...
                var LedgerData = (from t in accountingDBContext.Transactions
                                  ...
                                  (ledgerIds.Contains(ti.LedgerId)) && (((DateTime)t.TransactionDate).Date >= clientData.FromDate && ((DateTime)t.TransactionDate).Date <= clientData.ToDate)
                ...
                var dataList1 = (from t in accountingDBContext.Transactions
                                 ...
                                 ti.HospitalId == currentHospitalId
                                 && l.HospitalId == currentHospitalId &&
                                 (ledgerIds.Contains(ti.LedgerId)) && (((DateTime)t.TransactionDate).Date >= ((DateTime)openingBalanceFiscalYear.StartDate).Date && ((DateTime)t.TransactionDate).Date <= clientData.ToDate)
                                ...
                                into x
                                 select new
                                 {
                                     ...
                                     AmountDr = x.Where(b => b.ti.DrCr == true && ((DateTime)b.t.TransactionDate).Date < clientData.FromDate).Select(a => a.ti.Amount).DefaultIfEmpty(0).Sum(),// + (led.Where(a=> a.LedgerId == x.Key.LedgerId && a.DrCr == true).Select(a=>a.OpeningBalance).Sum()),
                                     AmountCr = x.Where(b => b.ti.DrCr == false && ((DateTime)b.t.TransactionDate).Date < clientData.FromDate).Select(a => a.ti.Amount).DefaultIfEmpty(0).Sum()// + (led.Where(a => a.LedgerId == x.Key.LedgerId && a.DrCr == false).Select(a => a.OpeningBalance).Sum()),
                                 }).ToList();
                              ...
                              select new
                              {
                                  ...
                                  TransactionItems = (showTxnItemLevel == true) ? null :
                                                                                    (from txnItm in accountingDBContext.TransactionItems
                                                                                     ...
                                                                                     && (((DateTime)txn.TransactionDate).Date >= clientData.FromDate && ((DateTime)txn.TransactionDate).Date <= clientData.ToDate)
        ...
        public IActionResult DailyTransactionReport(DateTime FromDate, DateTime ToDate)
        {
            ...
            Func<object> func = () => (from txn in _accountingDbContext.Transactions
                                       ...
                                       && (((DateTime)txn.TransactionDate).Date >= FromDate && ((DateTime)txn.TransactionDate).Date <= ToDate)
                                       && txn.IsVerified == true
        ...
        //                              (((DateTime)t.TransactionDate).Date == FromDate) && (t.FiscalyearId == fisc.FiscalYearId)
        ...
        //                              select new
        //                              {
        //                                  Amountdr = x.Where(b => b.ti.DrCr == true && (((DateTime)b.t.TransactionDate).Date >= b.fisc.StartDate && ((DateTime)b.t.TransactionDate).Date < FromDate)).Select(a => (int?)a.ti.Amount).DefaultIfEmpty(0).Sum(),
        //                                  Amountcr = x.Where(b => b.ti.DrCr == false && (((DateTime)b.t.TransactionDate).Date >= b.fisc.StartDate && ((DateTime)b.t.TransactionDate).Date < FromDate)).Select(a => (int?)a.ti.Amount).DefaultIfEmpty(0).Sum(),
        //                                  x.Key.FiscalYearId,
        //                              }).ToList();
        ...
        //                   txn.IsActive == true && (((DateTime)txn.TransactionDate).Date >= FromDate && ((DateTime)txn.TransactionDate).Date <= ToDate)
        ...
        //                       TransactionDate = ((DateTime)txn.TransactionDate).Date,// txn.TransactionDate.ToString("dd/mm/yyyy"),                                       
        ...
        //                      ti.HospitalId == currentHospitalId
        //                      && l.HospitalId == currentHospitalId &&
        //                      (ti.LedgerId == ledgerId) && (((DateTime)t.TransactionDate).Date >= FromDate && ((DateTime)t.TransactionDate).Date <= ToDate)
        //                      select new
        //                      {
        //                          t.TransactionId,
        //                          t.TransactionDate,
        ...
        //                     ti.HospitalId == currentHospitalId
        //                     && l.HospitalId == currentHospitalId &&
        //                     (ti.LedgerId == ledgerId) && (((DateTime)t.TransactionDate).Date >= ((DateTime)openingBalanceFiscalYear.StartDate).Date && ((DateTime)t.TransactionDate).Date <= ToDate)
        //                     group new { t, ti, l } by new
        //                     {
        //                         l.LedgerId,
        //                     }
        ...
        //                     {
        //                         FiscalYearId = fYearId,
        //                         AmountDr = x.Where(b => b.ti.DrCr == true && ((DateTime)b.t.TransactionDate).Date < FromDate).Select(a => (double?)a.ti.Amount).DefaultIfEmpty(0).Sum() + ((LedgerData.Count == 0 && led.LedgerId > 0 && led.DrCr == true) ? led.OpeningBalance : 0),
        //                         AmountCr = x.Where(b => b.ti.DrCr == false && ((DateTime)b.t.TransactionDate).Date < FromDate).Select(a => (double?)a.ti.Amount).DefaultIfEmpty(0).Sum() + ((LedgerData.Count == 0 && led.LedgerId > 0 && led.DrCr == false) ? led.OpeningBalance : 0),
        //                     }).ToList();
        ...
        //    //                                                                       where lgroup.COA == x2.Key.COA && lgroup.PrimaryGroup == x.Key.PrimaryGroup && lgroup.LedgerGroupName == x3.Key.LedgerGroupName //&& (((DateTime)t.TransactionDate).Date >= FromDate && ((DateTime)t.TransactionDate).Date <= ToDate)
        ...
        //    //                                                                           x4.Key.Code,
        //    //                                                                           OpenBal = x4.Where(b => b.lgroup.LedgerGroupName == "Cash In Hand" && (((DateTime)b.t.TransactionDate).Date < FromDate)).Select(a => (int?)a.ti.Amount).DefaultIfEmpty(0).Sum(),
        //    //                                                                           Amountdr = x4.Where(b => b.ti.DrCr == true && (((DateTime)b.t.TransactionDate).Date >= FromDate && ((DateTime)b.t.TransactionDate).Date <= ToDate)).Select(a => (int?)a.ti.Amount).DefaultIfEmpty(0).Sum(),
        //    //                                                                           Amountcr = x4.Where(b => b.ti.DrCr == false && (((DateTime)b.t.TransactionDate).Date >= FromDate && ((DateTime)b.t.TransactionDate).Date <= ToDate)).Select(a => (int?)a.ti.Amount).DefaultIfEmpty(0).Sum(),
        //    //                                                                       }).ToList()
        //    //                                                    }).ToList()
        //    //                             }).ToList()
        //    //              }).ToList();
        ...
        //                     {
        //                         FiscalYearId = fYearId,
        //                         AmountDr = x.Where(b => b.ti.DrCr == true && ((DateTime)b.t.TransactionDate).Date < FromDate).Select(a => (double?)a.ti.Amount).DefaultIfEmpty(0).Sum() + ((transactionRecords.Count == 0 && led.LedgerId > 0 && led.DrCr == true) ? led.OpeningBalance : 0),
        //                         AmountCr = x.Where(b => b.ti.DrCr == false && ((DateTime)b.t.TransactionDate).Date < FromDate).Select(a => (double?)a.ti.Amount).DefaultIfEmpty(0).Sum() + ((transactionRecords.Count == 0 && led.LedgerId > 0 && led.DrCr == false) ? led.OpeningBalance : 0),
        //                     }).ToList();
        ...
        private object GetLedgerReport(int ledgerId, DateTime FromDate, DateTime ToDate, int FiscalYearId)
        {
            ...
            var dataList1 = (from t in _accountingDbContext.Transactions
                            ...
                            into x
                             ...
                             {
                                 FiscalYearId = fYearId,
                                 AmountDr = x.Where(b => b.ti.DrCr == true && ((DateTime)b.t.TransactionDate).Date < FromDate).Select(a => a.ti.Amount).DefaultIfEmpty(0).Sum() + ((LedgerData.Count == 0 && led.LedgerId > 0 && led.DrCr == true) ? led.OpeningBalance : 0),
                                 AmountCr = x.Where(b => b.ti.DrCr == false && ((DateTime)b.t.TransactionDate).Date < FromDate).Select(a => a.ti.Amount).DefaultIfEmpty(0).Sum() + ((LedgerData.Count == 0 && led.LedgerId > 0 && led.DrCr == false) ? led.OpeningBalance : 0),
                             }).ToList();
        ...
        private object GetBankReconcilationReport(DateTime FromDate, DateTime ToDate, int ledgerId, int FiscalYearId)
        {
            ...
            var dataList1 = (from t in _accountingDbContext.Transactions
                            ...
                            into x
                             ...
                             {
                                 FiscalYearId = fYearId,
                                 AmountDr = x.Where(b => b.ti.DrCr == true && ((DateTime)b.t.TransactionDate).Date < FromDate).Select(a => a.ti.Amount).DefaultIfEmpty(0).Sum() + ((transactionRecords.Count == 0 && led.LedgerId > 0 && led.DrCr == true) ? led.OpeningBalance : 0),
                                 AmountCr = x.Where(b => b.ti.DrCr == false && ((DateTime)b.t.TransactionDate).Date < FromDate).Select(a => a.ti.Amount).DefaultIfEmpty(0).Sum() + ((transactionRecords.Count == 0 && led.LedgerId > 0 && led.DrCr == false) ? led.OpeningBalance : 0),
                             }).ToList();
        ...
        private object GetVoucherForVerification(int currentHospitalId,DateTime FromDate, DateTime ToDate, int sectionId)
        {
            ...
            var txnList = (from txn in _accountingDbContext.Transactions
                           ...
                           select new
                           {
                               ...
                               VoucherType = voucher.VoucherName,
                               SectionId = txn.SectionId,
                               TransactionDate = ((DateTime)txn.TransactionDate).Date,                                     
                               Amount = (from txnItm in _accountingDbContext.TransactionItems
                                         where txnItm.TransactionId == txn.TransactionId
                                         && txnItm.DrCr == true
                                         group txnItm by new
