...
namespace DanpheEMR.Controllers
{
    ...
    public class PatientBL
    {
        ...
        public static NewPatientUniqueNumbersVM GetPatNumberNCodeForNewPatient(string connString)
        {
            ...
            using (PatientDbContext patientDbContext = new PatientDbContext(connString))
            {
                var maxPatNo = patientDbContext.Patients.Any() ? patientDbContext.Patients.Max(p => p.PatientNo) : 0;
                newPatNo = maxPatNo + 1;
            }
