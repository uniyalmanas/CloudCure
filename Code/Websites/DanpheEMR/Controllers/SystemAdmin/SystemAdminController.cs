    ...
    public class SystemAdminController : CommonController
    {
        ...
        public IActionResult GetLoginInformation(DateTime fromDate, DateTime toDate)
        {
            ...
            Func<object> func = () => _systemAdminDbContext.LoginInformation
                .Where(log => ((DateTime)log.CreatedOn).Date >= fromDate && ((DateTime)log.CreatedOn).Date <= toDate).ToList();
            return InvokeHttpGetFunction(func);
        }
        ...
        private object PostRestoreDatabase( string ipDataStr)
        {
                ...
                DatabaseLogModel dbBackupLogDataFromClient = DanpheJSONConvert.DeserializeObject<DatabaseLogModel>(ipDataStr);
