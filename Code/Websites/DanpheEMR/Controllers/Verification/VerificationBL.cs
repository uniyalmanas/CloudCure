...
namespace DanpheEMR.Controllers
{
    public class VerificationBL
    {
        ...
        {
            var RequisitionList = pharmacyDbContext.StoreRequisition.Where(req => ((DateTime)req.CreatedOn).Date >= ((DateTime)FromDate).Date && ((DateTime)req.CreatedOn).Date <= ((DateTime)ToDate).Date && req.IsVerificationEnabled == true).OrderByDescending(a => a.RequisitionId).ToList();
