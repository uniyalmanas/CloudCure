...
namespace DanpheEMR.Controllers
{
    public class WardSupplyAssetsController : CommonController
    {
                ...
                using (var dbContextTransaction = wardSupplydbcontext.Database.BeginTransaction())
                {
                    try
                    {
                        ...
                        foreach (var item in dispatchItems)
                        {
                            ...
                            wardSupplydbcontext.FixedAssetStock.Attach(stkObj);
                            wardSupplydbcontext.Entry(stkObj).Property(x => x.SubStoreId).IsModified = true;
                            wardSupplydbcontext.SaveChanges();
                        }
                        ...
                        foreach (var requisitionItemId in allUniqueRequisitionItemIds)
                        {
                            ...
                            wardSupplydbcontext.WARDSupplyAssetRequisitionItemsModels.Attach(requisitionItem);
                            wardSupplydbcontext.Entry(requisitionItem).Property(x => x.ReceivedQuantity).IsModified = true;
                            wardSupplydbcontext.Entry(requisitionItem).Property(x => x.PendingQuantity).IsModified = true;
                            wardSupplydbcontext.Entry(requisitionItem).Property(x => x.RequisitionItemStatus).IsModified = true;
                            wardSupplydbcontext.Entry(requisitionItem).Property(x => x.ModifiedBy).IsModified = true;
                            wardSupplydbcontext.Entry(requisitionItem).Property(x => x.ModifiedOn).IsModified = true;
                            wardSupplydbcontext.SaveChanges();
                        }
                        ...
                        wardSupplydbcontext.WARDSupplyAssetRequisitionModels.Attach(requisitionModel);
                        wardSupplydbcontext.Entry(requisitionModel).Property(x => x.RequisitionStatus).IsModified = true;
                        wardSupplydbcontext.SaveChanges();
        ...
        private object AddAssetRequisition(string Str, RbacUser currentUser)
        {
            ...
            WARDSupplyAssetRequisitionModel RequisitionFromClient = DanpheJSONConvert.DeserializeObject<WARDSupplyAssetRequisitionModel>(Str);
            List<WARDSupplyAssetRequisitionItemsModel> requisitionItems = new List<WARDSupplyAssetRequisitionItemsModel>();
            WARDSupplyAssetRequisitionModel requisition = new WARDSupplyAssetRequisitionModel();
