...
namespace DanpheEMR.Services.Utilities
{
    public class UtilitiesService : IUtilitiesService
    {
        ...
        public object GetSchemeRefundTransaction(UtilitiesDbContext utilitiesDbContext, DateTime fromDate, DateTime toDate)
        {
            ...
            var query = (from refund in utilitiesDbContext.SchemeRefunds
                         ...
                         where refund.CreatedOn >= fromDateTime && refund.CreatedOn <= toDateTime && refund.IsActive == true
                         select new
                         {
                             SchemeRefundId = refund.SchemeRefundId,
                             RefundDate = refund.CreatedOn,
                             ...
                             Age = pat.Age + " / " + pat.Gender,
                             InpatientNumber = refund.InpatientNumber,
                             RefundAmount = refund.RefundAmount,
                             EnteredBy = emp.FullName,
                             Remarks = refund.Remarks,
                             CounterId = refund.CounterId
